namespace Uno.UI.Demo {
	export class Analytics {
		...
		public static reportPageView(screenName: string, appName: string = "cybertruck-wasm"): string {
		...
		private static init(screenName: string, appName: string): boolean {
			...
			script1.src = "https://www.googletagmanager.com/gtag/js?id=UA-26688675-18";
